...
public class Main {
    public static void main(String[] args) {
        ...
        // Test Calculator
        System.out.println("Sum: " + Calculator.sum(8, 2.34));
        System.out.println("Multiply: " + Calculator.multiply(4, 4.2));
        System.out.println("Divide: " + Calculator.divide(6, 2.5));
        System.out.println("Subtraction: " + Calculator.subtraction(6.1, 3));
