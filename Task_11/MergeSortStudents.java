...
public class MergeSortStudents {
    ...
    public MergeSortStudents(String name, int age) {
        this.name = name;
        this.age = age;
    }
    ...
    public static void main(String[] args){
        ...
        c.add(new String[]{"Max", "17"});
        c.add(new String[]{"Nicolas", "20"});
        c.add(new String[]{"Thomas", "19"});
        c.add(new String[]{"Dane", "17"});

        List<String[]> r = new ArrayList<>();
        r.add(new String[]{"Deneez","23"});
        r.add(new String[]{"Dora", "21"});
        r.add(new String[]{"Olaf", "27"});
